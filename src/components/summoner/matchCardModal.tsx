...
import { getMyPart } from '@/components/utils'
import {BanList} from './Bans'

import numeral from 'numeral'
import api from '@/external/api/api'
import { formatDatetimeFull, getTeam, ParticipantItems, convertTier, convertRank } from '../utils'
import {rankParticipants, type AppendParticipant} from '@/components/summoner/rankParticipants'
...
function MatchCardModal(props: MatchCardModalProps) {
  ...
  const {match_id, searchName} = router.query as {match_id: string, searchName: string}
  ...
  function participantLine(part: AppendParticipant) {
    ...
    return (
      <div style={{height: 120}}>
        ...
        <ParticipantItems part={part} match={match} />
